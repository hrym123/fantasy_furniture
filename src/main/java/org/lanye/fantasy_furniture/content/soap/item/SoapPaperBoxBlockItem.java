...
import org.lanye.fantasy_furniture.content.soap.client.SoapPaperBoxItemRenderer;
import org.lanye.reverie_core.geolib.GeolibBlockItem;
import org.lanye.reverie_core.geolib.GeolibItemAssets;

/** 包装盒物品：单 id，盒色存 NBT。 */
public final class SoapPaperBoxBlockItem extends GeolibBlockItem {

    public SoapPaperBoxBlockItem(Block block, Item.Properties properties, GeolibItemAssets assets) {
    ...
    public Component getName(ItemStack stack) {
        ...
        return Component.translatable(
                "item.fantasy_furniture.soap_paper_box.named",
        ...
        consumer.accept(
                new IClientItemExtensions() {
                    ...
                    public BlockEntityWithoutLevelRenderer getCustomRenderer() {
                        if (renderer == null) {
                            renderer = new SoapPaperBoxItemRenderer();
                        }
                        return renderer;
                    }
                });
    ...
    public static ItemStack stackWithMaterial(Item item, int materialId) {
        ...
        SoapPaperBoxAppearance.writeToStack(stack, new SoapPaperBoxAppearance(materialId));
        return stack;
    }
}
