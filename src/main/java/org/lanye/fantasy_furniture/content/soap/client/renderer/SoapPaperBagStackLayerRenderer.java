...
import org.lanye.fantasy_furniture.content.soap.client.model.SoapPaperBagStackGeoModel;
import software.bernie.geckolib.cache.object.BakedGeoModel;
import software.bernie.geckolib.cache.object.GeoBone;
import software.bernie.geckolib.renderer.GeoBlockRenderer;

/** 摞体单层 Pass：按 {@link SoapPaperBagStackRenderState} 隐藏其它 {@code blockN} 骨骼。 */
final class SoapPaperBagStackLayerRenderer extends GeoBlockRenderer<SoapPaperBagBlockEntity> {

    private static final Set<String> LAYER_BONES = Set.of("block1", "block2", "block3", "block4");

    SoapPaperBagStackLayerRenderer() {
        super(new SoapPaperBagStackGeoModel());
    }

    @Override
    public void actuallyRender(
            PoseStack poseStack,
            SoapPaperBagBlockEntity animatable,
            BakedGeoModel model,
    ...
    private static Map<GeoBone, Boolean> applyLayerBoneVisibility(BakedGeoModel model) {
        String visible = SoapPaperBagStackRenderState.visibleBone();
