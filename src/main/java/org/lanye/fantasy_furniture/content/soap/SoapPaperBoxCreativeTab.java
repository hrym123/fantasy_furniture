...
/** 创造栏：六色包装盒各一条。 */
public final class SoapPaperBoxCreativeTab {

    private SoapPaperBoxCreativeTab() {}
    ...
    public static ItemStack stackForMaterial(int materialId) {
        return SoapPaperBoxBlockItem.stackWithMaterial(ModBlocks.SOAP_PAPER_BOX.item().get(), materialId);
    }
}
