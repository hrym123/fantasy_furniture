...
/** 方案 1 组合模型档 {@code soap_rack_combo_full}。 */
public final class SoapRackComboFullGeoModel extends GeoModel<SoapRackBlockEntity> {

    @Override
    public ResourceLocation getModelResource(SoapRackBlockEntity animatable) {
        return SoapRackAssets.COMBO_FULL_MODEL;
    }

    @Override
    public ResourceLocation getTextureResource(SoapRackBlockEntity animatable) {
        return SoapRackAssets.COMBO_FULL_TEXTURE;
    }
